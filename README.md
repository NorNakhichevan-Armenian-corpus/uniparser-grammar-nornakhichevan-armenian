...
Refer to Uniparser repository (https://github.com/timarkh/uniparser-morph) and to the Eastern Armenian Uniparser repository (https://github.com/timarkh/uniparser-grammar-eastern-armenian/), both of which are used here.
